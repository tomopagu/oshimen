...
import rinahamu from './Idol/idols/rinahamu.jpg';
import nanase from './Idol/idols/nanase.jpg';
import ao from './Idol/idols/ao.jpg';
import tsukumoneru from './Idol/idols/tsukumoneru.jpg';
import yuka from './Idol/idols/yuka.jpg';
			...
			<Flex className="App" p={2}>
				<Box col={8} md={9} pr={2}>
					...
					<div className="group">
						...
						<Idol name="Rinahamu" group="CY8ER" image={ rinahamu } link="https://twitter.com/rinahamu" color="aqua" />
						...
						<Idol name="Tsukumo Neru" group="CYNHN" image={ tsukumoneru } link="https://twitter.com/tsukumoneru" color="#02a0ea" />
						<Idol name="Matsushita Reona" group="ManekiKecak" image={ matsushitareona } link="https://twitter.com/matsushitareona" color="red" />
						<Idol name="YUKA EMPiRE" group="EMPiRE" image={ yuka } link="https://twitter.com/YUKA_EMPiRE" color="black" />
						<Idol name="Ayuni D" group="BiSH" image={ ayunid } link="https://twitter.com/AYUNiD_BiSH" color="black" />
						<Idol name="Rin Kaname (Perorin)" group="Dempagumi.Inc" image={ perorin } link="https://twitter.com/peroperorinko01" color="yellow" />
